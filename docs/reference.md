...
- **Google sign-in and protected routes fail closed** — `ADMIN_EMAIL_ALLOWLIST` gates Google sign-in and every NextAuth-protected route; unset or empty denies all sign-ins and existing tokens receive 403
